...
; __config 0x3FFF
 ...
 FLAGS RES 1 ;BIT 0: INDICA SI ESTA EN MODO MANUAL (0) O MODO CONTROL POR COMPUTADORA (1)
 W_RAM RES 1
 STATUS_RAM RES 1
...
INT_RX:
    ...
    GOTO    VALOR2
    GOTO    VALOR3
    VALOR0  ;PARA ESTO SE IRA DE LA MANO DE QUE CON UDATA LAS VARIABLES SE VAN ESCRIBIENDO UNA 
    MOVF    RC_AUX,W ; TRAS OTRA EN LA RAM, EN DIRECCIONES CONTINUAS DE FORMA QUE LA DIRECCION
    MOVLW SERVO0_CENTENAS_RX ;DE SERVOX_UNIDADES_RC ES LA DIRECICON DE SERVOx_CENTENAS + 2
    ADDWF  CONTADOR_RC, W ;ASI CONTADOR RC DETERMINA SI SE GUARDA EN CENTENAS DECENAS  O UNIDADES
    MOVWF   FSR
    MOVF    
    VALOR1
    MOVF    RC_AUX,W
